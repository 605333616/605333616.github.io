...
"https://605333616.github.io/jekyll/update/2019/10/31/CSInformation.html",
"",
"",
"",
"",
...
for(var i=0;i<TofcLName.length;i++){
  ...
  for(var j=0;j<TofcLName[i].length;j++){
    TofcLNameUrl[i][j]=TofcNameUrl[i]+"#a"+j
  }
}



var TofcNum='<li><button class="TOfC">/</button><a href="https://605333616.github.io/jekyll/update/2019/10/31/CSindex.html">介绍</a></li>'
var TofcId="TofcId"
...
document.getElementById("c1").innerHTML=TofcNum;
  ...
  for(var i=0;i<TofcLName.length;i++){
    var TofcNum=""
    for(var j=0;j<TofcLName[i].length;j++){
    TofcLtext='<li><a href="'+TofcLNameUrl[i][j]+'">'+TofcLName[i][j]+'</a></li>';
